...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/plupload_1_5_7/plupload/js/plupload.full.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/plupload_1_5_7/plupload/js/i18n/zh-CN.js"></script>
<script type="text/javascript">
	...
	$(function() {
		uploader = new plupload.Uploader({//配置参数
			...
			flash_swf_url : '${pageContext.request.contextPath}/js/plupload_1_5_7/plupload/js/plupload.flash.swf',// Flash环境路径设置
			silverlight_xap_url : '${pageContext.request.contextPath}/js/plupload_1_5_7/plupload/js/plupload.silverlight.xap',//silverlight环境路径设置
...
<body>
	<form id="f1" action="${pageContext.request.contextPath}/DemoAction" method="post">
		<table border="1">
			...
			<tr>
				<th>姓名</th>
				<td><input name="name" value="刘领献" /></td>
			</tr>
			<tr>
				<th>密码</th>
